...
class IdentityDocumentUpload extends StatefulWidget {
  ...
  @override
  State<IdentityDocumentUpload> createState() => _IdentityDocumentUploadState();
}

class _IdentityDocumentUploadState extends State<IdentityDocumentUpload> {
  final SnackbarService _snackbarService = locator<SnackbarService>();

  String _errorNIDNumber = '';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: const Text20Medium("Nid Number"),
                    ),
                    CommonTextFieldView(
                      controller: _nidController,
                      focusNode: FocusNode(),
                      errorText: _errorNIDNumber,
                      labelText: "",
  ...
  bool _allValidation() {
    ...
    if (_nidController.text.trim().isEmpty) {
      _errorNIDNumber = StringValues.required_text;
      isValid = false;
    } else {
      _errorNIDNumber = '';
    }
