...
class BanksSearch extends SearchDelegate<BankInfoModel> {
  final List<BankInfoModel> banksList;

  late BankInfoModel selectedBank;

  BanksSearch(
    this.banksList,
  ) : super(
          searchFieldLabel: 'Search Bank',
  ...
  Widget buildLeading(BuildContext context) {
    return IconButton(
      ...
      onPressed: () {
        close(context, const BankInfoModel());
      },
    );
  }
    ...
    if (query.isEmpty) {
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) => Container(
          ...
          child: ListTile(
            onTap: () {
              selectedBank = suggestionList[index];
