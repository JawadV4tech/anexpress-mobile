...
class BranchesDropDown extends StatelessWidget {
  ...
  final List<BankBranchInfoModel>? items;

  final Function(BankBranchInfoModel)? onChanged;

  final FormFieldValidator<String>? validator;

  final BankBranchInfoModel? selectedBranch;
  ...
  _buildDropDownWidget(BuildContext context) {
    return Container(
      ...
      child: DropdownButtonFormField(
        ...
        items: items!.map((BankBranchInfoModel item) {
          return DropdownMenuItem<BankBranchInfoModel>(
            value: item,
