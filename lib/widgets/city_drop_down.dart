...
class CityDropDown extends StatelessWidget {
  ...
  final List<RecipientCity>? items;

  final RecipientCity? selectedCity;

  final Function(RecipientCity)? onChanged;
  ...
  _buildDropDownWidget(BuildContext context) {
    return Container(
      ...
      child: DropdownButtonFormField(
        ...
        items: items!.map((RecipientCity item) {
          return DropdownMenuItem<RecipientCity>(
            value: item,
