...
class SendingPurposeDropDown extends StatelessWidget {
  const SendingPurposeDropDown({
    super.key,
    this.shape,
    this.padding,
    this.variant,
  ...
  final List<SendingPurpose>? items;

  final Function(SendingPurpose)? onChanged;
  ...
  _buildDropDownWidget(BuildContext context) {
    return Container(
      ...
      child: DropdownButtonFormField(
        ...
        items: items!.map((SendingPurpose item) {
          return DropdownMenuItem<SendingPurpose>(
            value: item,
