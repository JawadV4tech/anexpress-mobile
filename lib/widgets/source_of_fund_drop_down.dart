...
class SourceOfFundDropDown extends StatelessWidget {
  const SourceOfFundDropDown({
    super.key,
    this.shape,
    this.padding,
    this.variant,
  ...
  final List<SourceOfFund>? items;

  final Function(SourceOfFund)? onChanged;
  ...
  _buildDropDownWidget(BuildContext context) {
    return Container(
      ...
      child: DropdownButtonFormField(
        ...
        items: items!.map((SourceOfFund item) {
          return DropdownMenuItem<SourceOfFund>(
            value: item,
